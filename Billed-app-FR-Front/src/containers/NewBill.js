  ...
  handleChangeFile = e => {
    ...
    errorMessage ? errorMessage.remove() : "";
     ...
     if (/^image\/(jpeg|jpg|png)$/.test(fileData.type)) {
      ...
      createErrorMessage.textContent = "Erreur : seuls les fichiers JPEG, JPG et PNG sont acceptés.";
      this.document.querySelector(".justificatif").appendChild(createErrorMessage);
      file.value ="";
     }
  }
  handleSubmit = e => {
